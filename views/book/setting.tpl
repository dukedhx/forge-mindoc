...
<head>
    ...
    <title>设置 - {{.Model.BookName}} - Autodesk Forge中国</title>
        ...
        <div class="row">
            ...
            <div class="page-right">
              ...
              <!--  <div class="form-group">
                    ...
                    <div class="controls">
                        <div class="switch switch-small" data-on="primary" data-off="info">
                            <input type="checkbox" id="autoSave" name="auto_save"{{if .Model.IsUseFirstDocument }} checked{{end}} data-size="small" placeholder="自动保存">
                        </div>
                    </div>
                </div>-->
                <div class="form-group">
