...
<head>
    ...
    <title>编辑文档 - Autodesk Forge中国</title>
    ...
    <link href="{{cdncss (print "/static/editor.md/lib/highlight/styles/" .HighlightStyle ".css") }}" rel="stylesheet">
...
<script src="{{cdnjs "/static/js/array.js" }}" type="text/javascript"></script>
